...
# Specify hyperparameters of the random forest
random_forest = RandomForestClassifier(n_estimators=433, criterion='entropy', max_depth=28,
                                       max_features=0.5771076262767284)
...
# region HYPERPARAMETER TUNING - RANDOM SEARCH - DECISION TREE - Potentially Traumatic Life Events
...
# Train the random search algorithm
model_dt = random_search_dt.fit(cmips_x, cmips_lec)
...
# Specify hyperparameters of the decision tree
dt = DecisionTreeClassifier(criterion='entropy', max_depth=76, random_state=1)
