...
# Get the features
cmips_x_1 = pd.read_csv(my_path + "/data/participants/for_analysis/for_models/reduced_features/feats_stressth.csv")
cmips_x_2 = pd.read_csv(my_path + "/data/participants/for_analysis/for_models/reduced_features/feats_stressct.csv")
...
cmips_x_1 = pd.DataFrame(cmips_x_1).fillna(0)
cmips_x_1 = cmips_x_1.values

cmips_x_2 = pd.DataFrame(cmips_x_2).fillna(0)
cmips_x_2 = cmips_x_2.values
...
scores_linear_reg = cross_validate(estimator=linear_reg, X=cmips_x_1, y=cmips_stressth,
...
scores_elastic_net = cross_validate(estimator=elastic_net, X=cmips_x_1, y=cmips_stressth,
                                    scoring=my_metrics, cv=kfold, n_jobs=-1, error_score='raise')
...
scores_lasso_reg = cross_validate(estimator=lasso_reg, X=cmips_x_1, y=cmips_stressth,
                                  scoring=my_metrics, cv=kfold, n_jobs=-1, error_score='raise')
...
scores_ridge_reg = cross_validate(estimator=ridge_reg, X=cmips_x_1, y=cmips_stressth,
                                  scoring=my_metrics, cv=kfold, n_jobs=-1, error_score='raise')
...
# Fit the elastic net with k-fold cross-validation
scores_xg_boost = cross_validate(estimator=xg_boost, X=cmips_x_1, y=cmips_stressth,
                                 scoring=my_metrics, cv=kfold, n_jobs=-1, error_score='raise')
...
# Fit the linear regression with k-fold cross-validation
scores_linear_reg = cross_validate(estimator=linear_reg, X=cmips_x_2, y=cmips_stressct,
                                   scoring=my_metrics, cv=kfold, n_jobs=-1, error_score='raise')
...
# Fit the elastic net with k-fold cross-validation
scores_elastic_net = cross_validate(estimator=elastic_net, X=cmips_x_2, y=cmips_stressct,
                                    scoring=my_metrics, cv=kfold, n_jobs=-1, error_score='raise')
...
# Fit the lasso regression with k-fold cross-validation
scores_lasso_reg = cross_validate(estimator=lasso_reg, X=cmips_x_2, y=cmips_stressct,
                                  scoring=my_metrics, cv=kfold, n_jobs=-1, error_score='raise')
...
# Fit the ridge regression with k-fold cross-validation
scores_ridge_reg = cross_validate(estimator=ridge_reg, X=cmips_x_2, y=cmips_stressct,
                                  scoring=my_metrics, cv=kfold, n_jobs=-1, error_score='raise')
...
# Fit the elastic net with k-fold cross-validation
scores_xg_boost = cross_validate(estimator=xg_boost, X=cmips_x_2, y=cmips_stressct,
                                 scoring=my_metrics, cv=kfold, n_jobs=-1, error_score='raise')
