...
# ......5a) Lifetime Stressor Severity ------------------------------------

# Filter the data
cmips_groups_long <- cmips_groups %>%
  select(label_StressTH, starts_with("fent")) %>%
  rename(stress_group = label_StressTH) %>%
  pivot_longer(cols = starts_with("fent"), names_to = "variable", values_to = "value")
...
# Save data to csv
write_csv(test_signf_results, "results/group_comparisons/fent_label_StressTH.csv")

# ......5a) Lifetime Stressor Count ------------------------------------

# Filter the data
cmips_groups_long <- cmips_groups %>%
  select(label_StressCT, starts_with("fent")) %>%
  rename(stress_group = label_StressCT) %>%
  pivot_longer(cols = starts_with("fent"), names_to = "variable", values_to = "value")
...
# Save data to csv
write_csv(test_signf_results, "results/group_comparisons/fent_label_StressCT.csv")

# ......5a) Perceived Stress ------------------------------------

# Filter the data
cmips_groups_long <- cmips_groups %>%
  select(label_PSS_total, starts_with("fent")) %>%
  rename(stress_group = label_PSS_total) %>%
  pivot_longer(cols = starts_with("fent"), names_to = "variable", values_to = "value")
...
# Save data to csv
write_csv(test_signf_results, "results/group_comparisons/fent_label_PSS_total.csv")

# ......5a) Potentially Traumatic Life Events -----------------------------

# Filter the data
cmips_groups_long <- cmips_groups %>%
  select(label_LEC_total, starts_with("fent")) %>%
  rename(stress_group = label_LEC_total) %>%
  pivot_longer(cols = starts_with("fent"), names_to = "variable", values_to = "value")
...
# Save data to csv
write_csv(test_signf_results, "results/group_comparisons/fent_label_LEC_total.csv")

# ......5a) Prejudiced Events -----------------------------

# Filter the data
cmips_groups_long <- cmips_groups %>%
  select(label_DHEQ_mean, starts_with("fent")) %>%
  rename(stress_group = label_DHEQ_mean) %>%
  pivot_longer(cols = starts_with("fent"), names_to = "variable", values_to = "value")
...
# Save data to csv
write_csv(test_signf_results, "results/group_comparisons/fent_label_DHEQ_mean.csv")

# ......5a) Identity Concealment -----------------------------

# Filter the data
cmips_groups_long <- cmips_groups %>%
  select(label_OI_mean, starts_with("fent")) %>%
  rename(stress_group = label_OI_mean) %>%
  pivot_longer(cols = starts_with("fent"), names_to = "variable", values_to = "value")
...
# Save data to csv
write_csv(test_signf_results, "results/group_comparisons/fent_label_OI_mean.csv")

# ......5a) Expected Rejection -----------------------------

# Filter the data
cmips_groups_long <- cmips_groups %>%
  select(label_SOER_total, starts_with("fent")) %>%
  rename(stress_group = label_SOER_total) %>%
  pivot_longer(cols = starts_with("fent"), names_to = "variable", values_to = "value")
...
# Save data to csv
write_csv(test_signf_results, "results/group_comparisons/fent_label_SOER_total.csv")

# ......5a) Internalized Stigma -----------------------------

# Filter the data
cmips_groups_long <- cmips_groups %>%
  select(label_IHS_mean, starts_with("fent")) %>%
  rename(stress_group = label_IHS_mean) %>%
  pivot_longer(cols = starts_with("fent"), names_to = "variable", values_to = "value")
...
# Save data to csv
write_csv(test_signf_results, "results/group_comparisons/fent_label_IHS_mean.csv")
